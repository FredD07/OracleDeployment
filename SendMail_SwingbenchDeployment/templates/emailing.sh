...
log "DB Server IPaddress           : $DB_IPADDRESS"
log "APPS Server IPaddress           : $APPS_IPADDRESS"
log "User to Connect            : $user"
log "User/Password              : $password"
log "SWINGBENCH HOME Path              : $swing_home"
...
log "	Replace <DB_IPADDRESS>"
sed -i "s|<DB_IPADDRESS>|${DB_IPADDRESS}|g" $temp_templated
log "	Replace <APPS_IPADDRESS>"
sed -i "s|<APPS_IPADDRESS>|${APPS_IPADDRESS}|g" $temp_templated
log "	Replace <SWING_PATH>"
sed -i "s|<SWING_PATH>|${swing_home}|g" $temp_templated
log "	Replace <DB_PATH>"
